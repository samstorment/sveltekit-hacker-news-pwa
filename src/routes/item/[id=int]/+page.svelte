...
<div class="max-w-screen-md mx-auto">
    <article>
        ...
        <div class="p-4 mb-4 text-zinc-500 py-4 flex flex-wrap gap-2 justify-between border-y border-zinc-300 dark:border-zinc-950">
        ...
        {#if data.content}
            <div class="prose text-inherit prose-a:text-zinc-500 max-w-full mb-4 px-4 pb-4 border-b-8 border-zinc-300 dark:border-zinc-950">
                {@html data.content}
            </div>
        {/if}
    </article>
