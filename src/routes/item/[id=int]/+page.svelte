...
<div class="max-w-screen-md mx-auto">
    <article>
        ...
        {#if data.content}
            <div class="prose text-inherit prose-a:dark:text-zinc-500 prose-a:break-words prose-pre:dark:bg-zinc-950 max-w-full mb-8 px-4 pb-8 border-b-8 border-zinc-300 dark:border-zinc-700">
                {@html data.content}
            </div>
        {/if}
    </article>
